...
/**
 * Word challenge returned from API
 * NOTE: correctTranslation is NOT included for security
 * It's only revealed after submitting an answer via checkTranslation
 */
