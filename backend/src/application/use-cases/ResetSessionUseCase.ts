...
export class ResetSessionUseCase
  implements IUseCase<ResetSessionInput, ResetSessionOutput, DomainError>
{
  constructor(
  ...
  execute(input: ResetSessionInput): Result<ResetSessionOutput, DomainError> {
    ...
    const deleted = this.sessionRepository.delete(sessionId);
